    ...
    >
      ...
      <div className="grid grid-cols-[auto,auto,auto] items-center">
        ...
        <View className="aspect-square h-[70vmin] min-h-40">
          ...
          <directionalLight intensity={6} position={[0, 1, 0]} />
        </View>
        {/* RIGHT  */}
...
function ArrowButton({label, onClick, direction="right"}:ArrowButtonProps){
  ...
  return(
    <button
          onClick={onClick}
          className="size-12 rounded-full border-2 border-white bg-white/10 p-3 opacity-85 ring-white focus:outline-none focus-visible:opacity-100 focus-visible:right-4 md:size-16 lg:size-20"
        >
